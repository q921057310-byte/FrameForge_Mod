...
def _smGetThickness(obj, foldface):
    ...
    if theVol < 0.0001:
        raise FrameForge2Exception(
            translate("FrameForge2", "Shape is not a real 3D-object or too small!"))
...
class VentFeature:
    ...
    def execute(self, fp):
        ...
        if thk < smEpsilon:
            raise FrameForge2Exception(
                translate("FrameForge2", "Could not determine material thickness."))

        sketch_obj = fp.Sketch
        sketch_shape = sketch_obj.Shape
        if sketch_shape is None or sketch_shape.isNull():
            raise FrameForge2Exception(
                translate("FrameForge2", "Sketch shape is invalid."))
        ...
        try:
            ...
            raise FrameForge2Exception(
                translate("FrameForge2", "Failed to cut boundary hole: ") + str(e))
        ...
        try:
            ...
            raise FrameForge2Exception(
                translate("FrameForge2", "Failed to fuse ribs: ") + str(e))
...
if App.GuiUp:
    ...
    class VentTaskPanel:
        def __init__(self, obj):
            ...
            self.form.setWindowTitle(translate("FrameForge2", "Vent"))
            layout = QtGui.QVBoxLayout(self.form)

            face_group = QtGui.QHBoxLayout()
            self.face_btn = QtGui.QPushButton(translate("FrameForge2", "Select Face"))
            ...
            self.sketch_btn = QtGui.QPushButton(translate("FrameForge2", "Select Sketch"))
            ...
            layout.addWidget(QtGui.QLabel(translate("FrameForge2", "Rib Edges (select from sketch):")))

            rib_sel_layout = QtGui.QHBoxLayout()
            self.rib_btn = QtGui.QPushButton(translate("FrameForge2", "Select Ribs"))
            self.rib_clear_btn = QtGui.QPushButton(translate("FrameForge2", "Clear"))
            ...
            self.rib_tree.setHeaderLabels([
                translate("FrameForge2", "Object"),
                translate("FrameForge2", "Edge"),
            ])
            ...
            wg.addWidget(QtGui.QLabel(translate("FrameForge2", "Rib Width:")))
            ...
            fg.addWidget(QtGui.QLabel(translate("FrameForge2", "Fillet:")))
        ...
        def _start_pick(self, mode):
            ...
            if mode == 'face':
                self.face_btn.setText(translate("FrameForge2", "Done"))
                self.face_txt.setText(translate("FrameForge2", "Select a face..."))
            elif mode == 'sketch':
                self.sketch_btn.setText(translate("FrameForge2", "Done"))
                self.sketch_txt.setText(translate("FrameForge2", "Select a sketch..."))
                try:
                ...
                self.rib_btn.setText(translate("FrameForge2", "Done (click to finish)"))
                rib = getattr(self.obj, "RibEdges", None)
        ...
        def _end_pick(self):
            if self._selection_mode is not None:
                ...
                self._selection_mode = None
                if mode == 'face':
                    self.face_btn.setText(translate("FrameForge2", "Select Face"))
                elif mode == 'sketch':
                    self.sketch_btn.setText(translate("FrameForge2", "Select Sketch"))
                elif mode == 'ribs':
                    self.rib_btn.setText(translate("FrameForge2", "Select Ribs"))
    ...
    class AddVentCommand:
        def GetResources(self):
            return {
                "Pixmap": TOOL_ICON,
                "MenuText": translate("FrameForge2", "Add Vent"),
                "Accel": "M, V",
                "ToolTip": translate(
                    "FrameForge2",
    ...
    Gui.addCommand("FrameForge2_AddVent", AddVentCommand())
