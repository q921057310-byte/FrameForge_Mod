...
class CreateCustomProfilesCommand:
    ...
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "Create Custom Profile"),
            "ToolTip": translate("FrameForge2", "Create a custom profile from selected edges"),
        }
...
Gui.addCommand("FrameForge2_CreateCustomProfiles", CreateCustomProfilesCommand())
