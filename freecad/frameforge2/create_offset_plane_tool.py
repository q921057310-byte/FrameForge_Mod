...
class CreateOffsetPlaneCommand:
    def GetResources(self):
        return {
            "Pixmap": TOOL_ICON,
            "MenuText": translate("FrameForge2", "Offset Datum Plane"),
            "ToolTip": translate(
                "FrameForge2",
    ...
    def Activated(self):
        ...
        distance, ok = QtGui.QInputDialog.getDouble(
            None, translate("FrameForge2", "Offset Datum Plane"),
            translate("FrameForge2", "Offset distance (mm, negative = opposite):"),
            10.0, -10000, 10000, 1)
        if not ok:
            return
        body = find_body(obj)
...
Gui.addCommand("FrameForge2_OffsetPlane", CreateOffsetPlaneCommand())
