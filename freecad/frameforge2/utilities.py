...
import freecad.frameforge2._utils as ffu
...
class ExportTechDrawCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "Export TechDraw to PDF"),
            "Accel": "M, E",
            "ToolTip": translate(
                "FrameForge2",
...
FreeCADGui.addCommand("FrameForge2_ExportTechDraw", ExportTechDrawCommand())
...
class RecomputeFrameForgeObjectsCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "Recursive Recompute"),
            "Accel": "M, Shift+R",
            "ToolTip": translate(
                "FrameForge2",
...
FreeCADGui.addCommand("FrameForge2_RecomputeFrameForgeObjects", RecomputeFrameForgeObjectsCommand())
