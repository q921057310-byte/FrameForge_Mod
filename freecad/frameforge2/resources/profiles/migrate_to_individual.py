...
LIB_FILE = os.path.join(App.getUserAppDataDir(), "Mod", "FrameForge2", "freecad", "frameforge2", "resources", "profiles", "AluminumProfiles.FCStd")
OUT_DIR  = os.path.join(App.getUserAppDataDir(), "Mod", "FrameForge2", "freecad", "frameforge2", "resources", "profiles", "aluminum")
