...
class ViewProviderTrimmedProfile:
    ...
    def setEdit(self, vobj, mode):
        ...
        import freecad.frameforge2.create_trimmed_profiles_tool

        taskd = freecad.frameforge2.create_trimmed_profiles_tool.CreateTrimmedProfileTaskPanel(
