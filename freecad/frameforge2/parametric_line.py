...
from freecad.frameforge2 import _utils
...
class CreateParametricLineCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": TOOL_ICON,
            "MenuText": translate("FrameForge2", "Parametric Line"),
            "ToolTip": translate("FrameForge2", "Create a parametric line from two vertices."),
        }

Gui.addCommand("FrameForge2_ParametricLine", CreateParametricLineCommand())
