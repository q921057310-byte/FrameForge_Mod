...
from freecad.frameforge2.gusset import Gusset, ViewProviderGusset
...
class CreateGussetTaskPanel:
    def __init__(self, obj):
        ...
        self.select1_btn = QtWidgets.QPushButton(translate("FrameForge2", "Select Face 1"))
        ...
        self.face1_label = QtWidgets.QLabel(translate("FrameForge2", "Not selected"))
        btn1_layout.addWidget(self.face1_label)
        sel_layout.addLayout(btn1_layout)

        btn2_layout = QtWidgets.QHBoxLayout()
        self.select2_btn = QtWidgets.QPushButton(translate("FrameForge2", "Select Face 2"))
        ...
        self.face2_label = QtWidgets.QLabel(translate("FrameForge2", "Not selected"))
        ...
        # Geometry group
        geo_group = QtWidgets.QGroupBox(translate("FrameForge2", "Geometry"))
        ...
        geo_layout.addRow(translate("FrameForge2", "Leg length 1"), self.spin_leg1)
        ...
        geo_layout.addRow(translate("FrameForge2", "Leg length 2"), self.spin_leg2)
        ...
        geo_layout.addRow(translate("FrameForge2", "Offset from corner"), self.spin_offset)
        ...
        geo_layout.addRow(translate("FrameForge2", "Thickness"), self.spin_thick)

        layout.addWidget(geo_group)

        # Options group
        opt_group = QtWidgets.QGroupBox(translate("FrameForge2", "Options"))
        ...
        opt_layout.addRow(translate("FrameForge2", "Thickness"), self.combo_thick_align)
        ...
        opt_layout.addRow(translate("FrameForge2", "Position"), self.combo_pos_align)
        ...
        opt_layout.addRow(translate("FrameForge2", "Position offset"), self.spin_pos_offset)
        ...
        opt_layout.addRow(translate("FrameForge2", "Hole diameter"), self.spin_hole_dia)
            ...
            try:
                if self.obj.Face1 and len(self.obj.Face1) > 0:
                    ...
                    if existing_obj is obj and existing_subs == (sub,):
                        App.Console.PrintMessage(translate("FrameForge2", "Select a different face\n"))
                        return
            except Exception:
                pass
    ...
    def open(self):
        App.Console.PrintMessage(translate("FrameForge2", "Opening Create Gusset\n"))
        App.ActiveDocument.openTransaction("Create Gusset")

    def reject(self):
        App.Console.PrintMessage(translate("FrameForge2", "Rejecting Create Gusset\n"))
    ...
    def apply(self):
        ...
        self.obj.Face1 = None
        self.obj.Face2 = None
        self.face1_label.setText(translate("FrameForge2", "Not selected"))
        self.face2_label.setText(translate("FrameForge2", "Not selected"))
    ...
    def accept(self):
        App.Console.PrintMessage(translate("FrameForge2", "Accepting Create Gusset\n"))
        App.ActiveDocument.commitTransaction()
        App.ActiveDocument.recompute()
        Gui.ActiveDocument.resetEdit()
        return True
...
class GussetCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "Gusset"),
            "Accel": "M, G",
            "ToolTip": translate(
                "FrameForge2",
...
Gui.addCommand("FrameForge2_Gusset", GussetCommand())
