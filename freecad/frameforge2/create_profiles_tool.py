...
from freecad.frameforge2.profile import Profile, ViewProviderProfile
from freecad.frameforge2.extrusions import make_tslot_face, make_vslot_face, make_profile_face, make_yiheda_vslot, make_aoh_vslot, make_40series_vslot
...
class CreateProfileTaskPanel(BaseProfileTaskPanel):
    ...
    def accept(self):
        if len(Gui.Selection.getSelectionEx()) or self.form_proxy.sb_length.value() > 0:
            App.Console.PrintMessage(translate("FrameForge2", "Accepting CreateProfile\n"))
            ...
            App.Console.PrintMessage(translate("FrameForge2", "Not Accepting CreateProfile\nSelect Edges or set Length"))
...
class CreateProfilesCommand:
    ...
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "Create Profile"),
            "ToolTip": translate("FrameForge2", "Create a new profile from selected edges"),
        }
...
Gui.addCommand("FrameForge2_CreateProfiles", CreateProfilesCommand())
