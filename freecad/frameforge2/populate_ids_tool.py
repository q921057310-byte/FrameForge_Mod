...
from freecad.frameforge2.populate_ids import populate_ids
...
class PopulateIDsTaskPanel:
    ...
    def open(self):
        App.Console.PrintMessage(translate("FrameForge2", "Opening Populate IDs\n"))

        # create a TrimmedProfile object
        App.ActiveDocument.openTransaction("Populate IDs")

    def reject(self):
        App.Console.PrintMessage(translate("FrameForge2", "Rejecting Populate IDs\n"))
...
class PopulateIDsCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "Populate IDs"),
            "Accel": "M, I",
            "ToolTip": translate(
                "FrameForge2",
...
class ResetIDsCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "Reset IDs"),
            "Accel": "M, 0",
            "ToolTip": translate(
                "FrameForge2",
...
Gui.addCommand("FrameForge2_PopulateIDs", PopulateIDsCommand())
Gui.addCommand("FrameForge2_ResetIDs", ResetIDsCommand())
