...
from freecad.frameforge2.best_fit import CutPart, Stock, best_fit_decreasing
from freecad.frameforge2.create_bom import (
    group_links,
    group_profiles,
    make_bom,
    make_cut_list,
...
class CreateBOMTaskPanel:
    ...
    def open(self):
        App.Console.PrintMessage(translate("FrameForge2", "Opening CreateBOM\n"))

        # create a TrimmedProfile object
        App.ActiveDocument.openTransaction("Make BOM")

    def reject(self):
        App.Console.PrintMessage(translate("FrameForge2", "Rejecting CreateBOM\n"))
...
class CreateBOMCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("FrameForge2", "BOM"),
            "Accel": "M, B",
            "ToolTip": translate("FrameForge2", "Generate a Bill of Materials (BOM) spreadsheet for the current design")
        }
...
Gui.addCommand("FrameForge2_CreateBOM", CreateBOMCommand())
