...
def _findBoundaryWire(sketch_shape):
    ...
    if best:
        return best
    from freecad.frameforgemod.create_vent_tool import _make_wire_from_edges
...
class PatternFill:
    ...
    def execute(self, fp):
        ...
        from freecad.frameforgemod.create_offset_plane_tool import find_body
        ...
        from freecad.frameforgemod.create_vent_tool import _getElementFromTNP
        face_found = False
        if base_sub_names:
            try:
        ...
        from freecad.frameforgemod.create_vent_tool import _smGetThickness
        ...
        if boundary_wire is None:
            raise FrameForgemodException("Cannot find closed boundary in sketch.")
        ...
        try:
            ...
            raise FrameForgemodException("Pattern failed: " + str(e))
...
if App.GuiUp:
    ...
    Gui.addCommand("frameforgemod_PatternFill", PatternFillCommand())
