...
class CreateBalloonsCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("frameforgemod", "Create Balloons"),
            "Accel": "M, B",
            "ToolTip": translate(
                "frameforgemod",
...
class ResfreshBalloonsCommand:
    def GetResources(self):
        return {
            ...
            "MenuText": translate("frameforgemod", "Resfresh Balloons"),
            "Accel": "M, B",
            "ToolTip": translate(
                "frameforgemod",
...
Gui.addCommand("frameforgemod_CreateBalloons", CreateBalloonsCommand())
Gui.addCommand("frameforgemod_RefreshBalloons", ResfreshBalloonsCommand())
