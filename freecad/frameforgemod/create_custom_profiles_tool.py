...
class CreateCustomProfilesCommand:
    ...
    def GetResources(self):
        return {
            ...
            "Accel": "Shift+C",  # 默认快捷键（可选）
            "MenuText": translate("frameforgemod", "Create Custom Profile"),
            "ToolTip": translate("frameforgemod", "Create a custom profile from selected edges"),
        }
...
Gui.addCommand("frameforgemod_CreateCustomProfiles", CreateCustomProfilesCommand())
