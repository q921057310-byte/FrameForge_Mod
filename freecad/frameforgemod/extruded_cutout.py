...
from freecad.frameforgemod._utils import (
    get_children_from_extrudedcutout,
...
class ExtrudedCutout:
    def __init__(self, obj, sketch, selected_face):
        ...
        obj.addProperty(
            ...
            "Sketch",
            "ExtrudedCutout",
            translate("frameforgemod", "The sketch for the cut"),
        ).Sketch = sketch
        ...
        obj.addProperty(
            ...
            "ExtrusionLength",
            "ExtrudedCutout",
            translate("frameforgemod", "Length of the extrusion direction 1"),
        ).ExtrusionLength = 500.0
        obj.setEditorMode("ExtrusionLength", 2)  # Hide by default

        # CutType property
        obj.addProperty(
            "App::PropertyEnumeration", "CutType", "ExtrudedCutout", translate("frameforgemod", "Cut type")
        ).CutType = [
            "Through All",
            "Distance",
        ]
    ...
    def execute(self, fp):
        ...
        except FrameForgemodException as e:
...
class ViewProviderExtrudedCutout:
    ...
    def setEdit(self, vobj, mode):
        ...
        import freecad.frameforgemod.create_extruded_cutout_tool

        taskd = freecad.frameforgemod.create_extruded_cutout_tool.CreateExtrudedCutoutTaskPanel(self.Object)
